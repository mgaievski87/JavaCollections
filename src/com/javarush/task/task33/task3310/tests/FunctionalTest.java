...
public class FunctionalTest extends Assert {
    ...
    public void testStorage(Shortener shortener){
        ...
        String retrievedString1 = shortener.getString(id1);
        String retrievedString2 = shortener.getString(id2);
        String retrievedString3 = shortener.getString(id3);

        Assert.assertEquals(string1, retrievedString1);
        Assert.assertEquals(string2, retrievedString2);
        Assert.assertEquals(string3, retrievedString3);
